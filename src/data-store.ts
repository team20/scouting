...
export function combineData(): string {
	...
	return [
		...
		autoInfo.fuelScoredRobotCounter,
		autoInfo.climbAttemptedToggle,
		autoInfo.climbSuccessfulToggle,

		teleopInfo.fuelScoredRobotCounter,
		teleopInfo.fuelPassed,
		teleopInfo.fuelScoredHumanCounter,
		teleopInfo.foulsCounter,
